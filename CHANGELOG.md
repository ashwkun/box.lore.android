...
- CI pipeline now automatically deletes orphan `release/v*` branches after successful publish via `delete_branch_on_merge` and `prepare_release.py delete‑release‑branch`. ([#871](https://github.com/ashwkun/boxlore/pull/871)) <!-- impact:no-user-impact -->
## [v0.0.8] - 2026-07-12
