...
- Modular Android hardening (plan A0–A8 / B0–B10): single `AppContainer` composition root with `create`/`install` for RSS and ranking; extracted `:core:prefs`, `:core:downloads`, `:core:analytics`, `:core:ranking`, `:core:rss` (catalog stays the orchestration module); `MainActivity` slimmed to a shell over `BoxLoreNavHost`; `DownloadServiceLauncher` replaces reflective `Class.forName`; AGP 9 toolchain and Develocity wiring; module README contracts. ([#903](https://github.com/boxcreate/boxlore/pull/903), [#902](https://github.com/boxcreate/boxlore/pull/902)) <!-- impact:no-user-impact -->
- Feature and playback extractions under LOC caps: home/playback splits, then info/library/explore/onboarding/analytics module boundaries so UI flows live under `:feature:*` and shared engines under `:core:*`. ([#919](https://github.com/boxcreate/boxlore/pull/919), [#920](https://github.com/boxcreate/boxlore/pull/920)) <!-- impact:no-user-impact -->
- Phase 2 package alignment: PostHog façade so feature modules never import PostHog directly (use `:core:analytics`); analytics glossary replace; satellite/prefs migration; playback/database package align + Auto Phase C; catalog package align + Phase 2 final signoff. ([#921](https://github.com/boxcreate/boxlore/pull/921), [#922](https://github.com/boxcreate/boxlore/pull/922), [#923](https://github.com/boxcreate/boxlore/pull/923), [#924](https://github.com/boxcreate/boxlore/pull/924), [#925](https://github.com/boxcreate/boxlore/pull/925)) <!-- impact:no-user-impact -->
- Architecture-as-code and test harness: Konsist/boundary guards fail CI on graph drift (no feature→feature, no Hilt/MockK, catalog boundaries); expanded hermetic JVM suites and `:core:testing` fakes; raised merged Kover floor; Roborazzi verify in the unit gate; `ARCHITECTURE.md` / `TESTING.md` hubs and ranking cross-links. ([#930](https://github.com/boxcreate/boxlore/pull/930), [#910](https://github.com/boxcreate/boxlore/pull/910), [#918](https://github.com/boxcreate/boxlore/pull/918), [#926](https://github.com/boxcreate/boxlore/pull/926), [#927](https://github.com/boxcreate/boxlore/pull/927), [#928](https://github.com/boxcreate/boxlore/pull/928), [#929](https://github.com/boxcreate/boxlore/pull/929)) <!-- impact:no-user-impact -->
