...
<b>🐛 Fixes:</b>
<ul align="left">
<li>Player now stays in sync when you reopen the app, so mini and full player show the same playback state. <a href="https://github.com/ashwkun/boxlore/pull/904"><img src="https://img.shields.io/badge/PR-904-6750A4?style=flat-square" alt="PR #904" height="18"/></a></li>
</ul>
