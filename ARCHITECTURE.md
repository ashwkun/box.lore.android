...
```text
:app
:core:model | :core:network | :core:domain | :core:database | :core:data | :core:playback
...
| `:core:data` | Repositories, ranking, RSS (`RssFeedClient`), workers, prefs, analytics |
...
Primary stack: **playback → data → domain / database / network / model**.
