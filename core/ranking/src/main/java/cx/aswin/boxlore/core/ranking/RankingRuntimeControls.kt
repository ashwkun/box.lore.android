...
class RankingRuntimeControls private constructor(
    context: Context,
) {
    ...
    fun isAdaptiveEnabled(
        ...
        preferences.getBoolean(ADAPTIVE_ENABLED, true) &&
...
object RankingShadowDiagnostics {
    ...
    fun record(
        ...
        val comparable =
            adaptiveOrder.mapIndexedNotNull { index, id ->
