...
class AdaptiveCandidateScorer private constructor(
                ...
                val features =
                    CandidateFeatureBuilder.build(
                        CandidateSignals(
                            ...
                            ageHours =
                                (nowMs / 1_000.0 - input.episode.publishedDate)
    ...
    suspend fun rankEpisodes(
        ...
        val ranked =
            DiversityReranker
                .rerank(candidates, diversityPolicy)
        ...
        if (runtimeControls.isShadowDiagnosticsEnabled() &&
            ...
            RankingShadowDiagnostics.record(
                ...
                priorOrder =
                    inputs
                        .sortedByDescending(EpisodeRankingInput::priorScore)
                        .map { it.episode.id },
    ...
    suspend fun rankPodcasts(
        ...
        val ordered =
            if (diversityPolicy == null) {
                scored
                    .distinctBy(RankedCandidate<Podcast>::episodeId)
        ...
        if (runtimeControls.isShadowDiagnosticsEnabled() &&
            ...
            RankingShadowDiagnostics.record(
                ...
                priorOrder =
                    inputs
                        .sortedByDescending(PodcastRankingInput::priorScore)
                        .map { it.podcast.id },
...
private fun Podcast.rankingGenres(): List<String> =
    genre
        .split(",")
