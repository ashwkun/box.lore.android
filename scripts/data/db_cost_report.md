...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 4 | 149,868 | 3,965 |
|  | `refresh-charts` | 2 | 81,734 | 57,570 |
|  | `sync-episodes` | 4 | 50,580 | 4,498 |
|  | `vectorize-episodes` | 4 | 142,378 | 2,368 |
|  | `vectorize-shows` | 3 | 60,778 | 923 |
| | **Day total** | | **485,338** | **69,324** |
