...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 4 | 146,696 | 4,100 |
|  | `refresh-charts` | 1 | 81,230 | 56,504 |
|  | `sync-episodes` | 4 | 50,242 | 3,818 |
|  | `vectorize-episodes` | 4 | 145,275 | 1,414 |
|  | `vectorize-shows` | 4 | 80,539 | 1,027 |
| | **Day total** | | **503,982** | **66,863** |
