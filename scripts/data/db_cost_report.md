...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 1 | 37,467 | 3,965 |
|  | `refresh-charts` | 1 | 81,734 | 57,570 |
|  | `sync-episodes` | 1 | 49,581 | 2,500 |
|  | `vectorize-episodes` | 1 | 35,408 | 265 |
|  | `vectorize-shows` | 1 | 23,336 | 923 |
| | **Day total** | | **227,526** | **65,223** |
