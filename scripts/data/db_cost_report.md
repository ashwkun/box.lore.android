...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 7 | 226,177 | 5,180 |
|  | `refresh-charts` | 5 | 322,049 | 181,157 |
|  | `sync-episodes` | 7 | 244,502 | 2,444 |
|  | `vectorize-episodes` | 7 | 411,600 | 2,596 |
|  | `vectorize-shows` | 4 | 201,436 | 1,688 |
| | **Day total** | | **1,405,764** | **193,065** |
