...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 4 | 139,536 | 3,835 |
|  | `refresh-charts` | 1 | 80,731 | 54,783 |
|  | `sync-episodes` | 4 | 50,381 | 3,686 |
|  | `vectorize-episodes` | 4 | 147,097 | 928 |
|  | `vectorize-shows` | 4 | 82,581 | 1,033 |
| | **Day total** | | **500,326** | **64,265** |
