...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 2 | 62,959 | 12 |
|  | `refresh-charts` | 2 | 32,805 | 631 |
|  | `sync-episodes` | 1 | 48,591 | 72 |
|  | `vectorize-episodes` | 1 | 59,680 | 137 |
|  | `vectorize-shows` | 1 | 91,591 | 18,482 |
| | **Day total** | | **295,626** | **19,334** |
