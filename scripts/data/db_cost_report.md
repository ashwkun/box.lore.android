...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 2 | 71,596 | 4,570 |
|  | `refresh-charts` | 1 | 81,734 | 57,960 |
|  | `sync-episodes` | 2 | 50,676 | 4,466 |
|  | `vectorize-episodes` | 2 | 75,278 | 497 |
|  | `vectorize-shows` | 2 | 44,166 | 1,210 |
| | **Day total** | | **323,450** | **68,703** |
