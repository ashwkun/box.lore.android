...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 1 | 34,117 | 0 |
|  | `sync-episodes` | 1 | 49,206 | 1,052 |
|  | `vectorize-episodes` | 1 | 35,751 | 206 |
|  | `vectorize-shows` | 1 | 19,620 | 0 |
| | **Day total** | | **138,694** | **1,258** |
