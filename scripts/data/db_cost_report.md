...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 3 | 104,652 | 3,835 |
|  | `refresh-charts` | 1 | 80,731 | 54,783 |
|  | `sync-episodes` | 3 | 50,335 | 3,594 |
|  | `vectorize-episodes` | 3 | 111,011 | 703 |
|  | `vectorize-shows` | 3 | 63,227 | 1,033 |
| | **Day total** | | **409,956** | **63,948** |
