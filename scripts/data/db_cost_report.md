...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 3 | 94,440 | 12 |
|  | `refresh-charts` | 3 | 48,813 | 643 |
|  | `sync-episodes` | 2 | 97,519 | 818 |
|  | `vectorize-episodes` | 2 | 119,561 | 356 |
|  | `vectorize-shows` | 2 | 163,753 | 24,382 |
| | **Day total** | | **524,086** | **26,211** |
