...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 2 | 73,348 | 4,100 |
|  | `refresh-charts` | 1 | 81,230 | 56,504 |
|  | `sync-episodes` | 2 | 50,056 | 3,446 |
|  | `vectorize-episodes` | 2 | 72,883 | 523 |
|  | `vectorize-shows` | 2 | 42,837 | 1,027 |
| | **Day total** | | **320,354** | **65,600** |
